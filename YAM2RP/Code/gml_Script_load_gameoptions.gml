...
set_default_joypad()
set_default_xjoypad()
if (!(file_exists(((working_directory + "/multitroid/") + "qf.config.ini"))))
    save_gameoptions()
if file_exists(((working_directory + "/multitroid/") + "qf.config.ini"))
{
    ini_open(((working_directory + "/multitroid/") + "qf.config.ini"))
...
{
    if (global.opjoybtn_xax >= 4 && joystick_axes(global.opjoyid) < 4)
        global.opjoybtn_xax = 0
    if (global.opjoybtn_xax >= 2 && joystick_axes(global.opjoyid) < 2)
        global.opjoybtn_xax = 0
    if (global.opjoybtn_yax >= 4 && joystick_axes(global.opjoyid) < 4)
        global.opjoybtn_yax = 1
    if (global.opjoybtn_yax >= 2 && joystick_axes(global.opjoyid) < 2)
        global.opjoybtn_yax = 1
    if (global.opjoybtn_xax >= 6 && joystick_has_pov(global.opjoyid) == 0)
        global.opjoybtn_xax = 0
