                ...
                else
                {
                    if (instance_exists(oCharacter) && oCharacter.invincible == 0)
                    {
                        with (oCharacter)
                        {
                            ...
                            {
                                if (checkBeam && (!global.freezeDisabled || checkCharge) && global.playerFreeze == 0 && invincible == 0 && canbehit && state != IDLE && state != SAVING && state != SAVINGFX && state != SAVINGSHIPFX && state != SAVINGSHIP && state != ELEVATOR && state != GFELEVATOR)
                                {
